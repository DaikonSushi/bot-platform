...
type MessageEvent struct {
	...
	IsAdmin       bool                   `protobuf:"varint,9,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"` // true if sender is configured as bot admin
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MessageEvent) GetIsAdmin() bool {
	if x != nil {
		return x.IsAdmin
	}
	return false
...
const file_api_proto_plugin_proto_rawDesc = "" +
	...
	"\x13handle_all_messages\x18\x06 \x01(\bR\x11handleAllMessages\"\xbc\x02\n" +
	...
	"\x06sender\x18\b \x01(\v2\x10.plugin.UserInfoR\x06sender\x12\x19\n" +
	"\bis_admin\x18\t \x01(\bR\aisAdmin\"\x93\x01\n" +
